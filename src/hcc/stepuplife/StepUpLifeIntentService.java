 ...
 */
public class StepUpLifeIntentService extends IntentService {
    ...
    private SharedPreferences mPrefs; //settings

    public StepUpLifeIntentService() {
        // Set the label for the service's background thread
        super("StepUpLifeIntentService");
    }
